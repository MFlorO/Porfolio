...
const TryMyBackend = () => {
  ...
  return (
    <section className="w-full lg:w-[48%] h-max-[850px] h-[750px] lg:h-full lg:h-max-full flex flex-col bg-gray-800 p-6 rounded-xl text-sm space-y-4 text-white/90 dark:text-white/60" id={Seccion.BACKEND}>
      ...
      <div className="w-full max-h-72 md:max-h-64 bg-gray-900 p-3 rounded-lg text-pink-400 text-sm font-mono">
      {
        !state 
        ...
        : isPending 
          ...
          : <div className="w-full max-h-64 md:max-h-60 overflow-auto scrollbar scrollbar-thin scrollbar-thumb-brand-pinkFluor scrollbar-track-gray-700 transition-opacity duration-300 ease-in opacity-0 animate-fadeIn">
